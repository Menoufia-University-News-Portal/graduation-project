...
const ComersDetails = () => {
    ...
    useEffect(() => {
        const fetchNewsItem = async () => {
            try {
                const response = await axios.get(`http://localhost:3001/comers-news/${id}`);
            ...
            <div className="news-details-container0">
                <div className="news-details-grid">
                    <div className="news-details-content">
                        <h2 style={{marginTop:"130px"}}>{newsItem.title}</h2>
              ...
              <p className="faculty-name2">كلية  {newsItem.faculties[0]?newsItem.faculties[0].name:" "} <span><FaLocationDot /></span></p>
                        ...
                        <p style={{marginBottom:"0px"}}>{newsItem.description}</p>
                    ...
                    <div className="news-details-image">
                        <img  src ={`http://localhost:3001/${newsItem.link}`}  alt={newsItem.title} style={{marginTop:"120px"}} />
                    </div>
                </div>
            </div>
            <div className="related-news" style={{marginTop:"30px"}}>
