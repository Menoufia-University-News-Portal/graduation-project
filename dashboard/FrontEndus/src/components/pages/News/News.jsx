...
export default function News() {
    ...
    const [filters, setFilters] = useState({
        ...
        news_id: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.EQUALS }] },
    ...
    const DescriptionBodyTemplate = ({ data }) => {
        ...
        return (
            <div className="flex align-items-center gap-2">
                <span dir="rtl">{data.description}</span>
            </div>
        );
    };
    ...
    async function handledelete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                     axios.delete(`http://localhost:3001/news/delete/${id}`);
    ...
    const ImageBodyTemplate = ({ data }) => {
        ...
        console.log(`http://localhost:3001/${data.link}`);
    };
    ...
    const ActionBodyTemplate = ({ data }) => {
        ...
        return (
            <div className='d-flex align-items-center gap-2'>
                ...
                <button className="btn3"  onClick={() => handledelete(data.news_id)} > Delete </button>
