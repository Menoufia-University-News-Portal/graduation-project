...
export default function Gallary() {
    ...
    const [deletegallary, setdeletegallary] = useState(false);
    const [filters, setFilters] = useState({
        global: { value: null, matchMode: FilterMatchMode.CONTAINS },
        image_id: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.EQUALS }] },
    ...
    useEffect(() => {
        const res = fetch('http://localhost:3001/gallery/list')
            .then(res => res.json())
    ...
    const renderHeader = () => {
        return (
            ...
            <div className="first" >
                <h4 className="m-0"> Gallery Page </h4>
    ...
    const ActionBodyTemplate = ({ data }) => {
        ...
        return (
            <div className='d-flex align-items-left gap-4'>
                ...
                <button className="btn3" onClick={() => delete2(data.image_id)} > Delete </button>
            </div>
        );
    };
            ...
            <div>
                ...
                <div className="card" >
                    ...
                    <DataTable
                        ...
                        selection={selectedgallary}
                        onSelectionChange={(e) => setselectedgallary(e.value)}
                        filters={filters}
                        filterDisplay="menu"
                        globalFilterFields={['image_id', 'link']}
